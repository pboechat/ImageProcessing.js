		...
		*/
		...
		if (base == document.body) {
			...
			this._doOnResizeStart = function() {
				...
				//}
				// this._lw = document.documentElement.clientHeight;
			}
...
dhtmlXLayoutObject.prototype.unload = function(removeParent) {
	...
	if (this._doOnResizeStart) {
		if (_isIE) { window.detachEvent("onresize", this._doOnResizeStart); } else { window.removeEventListener("resize", this._doOnResizeStart, false); }
...
dhtmlXLayoutObject.prototype.attachHeader = function(obj) {
	...
	var ofsH = obj.offsetHeight+(this.skin=="dhx_web"?9:2)+2;
	this.cont.obj._offsetTop = ofsH;
...
dhtmlXLayoutObject.prototype.attachFooter = function(obj) {
	...
	var ofsH = obj.offsetHeight+(this.skin=="dhx_web"?9:2)-2;
	//this.cont.obj._offsetTop = ofsH;
	this.cont.obj._offsetHeight = this.cont.obj._offsetHeight-ofsH;
	this.setSizes();
